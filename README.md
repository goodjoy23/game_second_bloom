...
- 여자 화자: 이인선 — 48세, 직장인
- 구성: 15상황 × 2시선 = 30편, 프롤로그와 에필로그 포함 약 9만 자
...
```text
[상황 01] 다시 연락한 이유
  ├─ 창근의 시선 : 보내고 휴대폰을 엎어놨다. 읽음 표시만 있었다
  ├─ 인선의 시선 : 답장을 쓰다 지웠다, 세 번
  └─ 여백 페이지 : "버리기엔 멀쩡해서요."
```

젊은 연애 소설은 무슨 일이 일어났는가로 읽히고, 중년 연애 소설은 같은 일을 왜 다르게 읽었는가로 읽힌다. 이 어긋남을 열다섯 번 만드는 것이 소설판의 유일한 설계 목표다.
...
8. [상황 01 견본 원고 · 창근](novel/manuscript/창근/s01_창근.md)
9. [상황 01 견본 원고 · 인선](novel/manuscript/인선/s01_인선.md)
10. [이창근 캐릭터 시트](docs/캐릭터/이창근.md)
